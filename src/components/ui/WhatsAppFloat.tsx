...
export function WhatsAppFloat({ user }: WhatsAppFloatProps) {
  ...
  const [chatHistory, setChatHistory] = useState<ChatMessage[]>(() => {
    ...
    return [
      {
        sender: 'solo',
        text: "Habari! Welcome to Solo's Electronics' Support Desk. I can assist you with your orders, fast delivery in Lira/Uganda, or repair inquiries. How can I help you today?",
  ...
  const triggerAutomatedReply = (userText: string) => {
    ...
    setTimeout(() => {
      ...
      if (text.includes('lira') || text.includes('location') || text.includes('where') || text.includes('coordinates') || text.includes('map') || text.includes('address')) {
        ...
        response = "Every catalog unit at Solo's Electronics is 100% authentic, brand-new, and sealed. All items are backed by a comprehensive 1-year product warranty. Your technical confidence is our system's top priority!";
  ...
  return (
    <div className="fixed bottom-24 right-4 md:bottom-8 md:right-8 z-50 flex flex-col items-end gap-3 pointer-events-none">
              ...
              <div className="flex flex-col h-full bg-black/90 p-6 justify-between text-left">
                <div className="space-y-4">
                  ...
                  <p className="text-[11px] text-gray-400 leading-relaxed">
                    How would you like to connect with Solo's Electronics support? Choose your preferred logistics interface.
                  </p>
              ...
              <>
                ...
                <div className="bg-zinc-950 border-b border-white/[0.05] p-4 text-white flex justify-between items-center shrink-0">
                  <div className="flex items-center gap-2.5 text-left">
                    ...
                    <div>
                      <h4 className="text-[11px] font-black uppercase tracking-wider font-mono">Solo's Desk</h4>
      ...
      >
        <WhatsAppIcon className="text-white shrink-0 group-hover:rotate-12 transition-transform duration-300" size={24} />
